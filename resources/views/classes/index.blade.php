                            ...
                            <div class="card-footer bg-transparent">
                                <div class="btn-group w-100" role="group">
                                    ...
                                    <form action="{{ route('admin.classes.destroy', $class) }}" method="POST"
                                        class="d-inline delete-class-form">
                                        @csrf
                                        @method('DELETE')
                                        <button type="button" class="btn btn-sm btn-outline-danger btn-delete-class"
                                            data-class-name="{{ $class->name }}" data-class-id="{{ $class->id }}"
                                            title="Hapus">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    Apakah Anda yakin ingin menghapus kelas <strong id="deleteClassName"></strong>?
                </div>
